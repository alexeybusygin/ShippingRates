...
//            _provider = new FedExRestFreightLtlProvider(new FedExProviderConfiguration()
//            {
...
//            _providerNegotiated = new FedExRestFreightLtlProvider(new FedExProviderConfiguration()
//            {
//                ClientId = config.FedExRestClientId,
//                ClientSecret = config.FedExRestSecret,
//                AccountNumber = config.FedExRestAccountNumber,
