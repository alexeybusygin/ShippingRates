...
//        public FedExRestFreightLtlProvider(FedExProviderConfiguration configuration)
//            : base(configuration) { }
...
//        /// <param name="configuration"></param>
//        /// <param name="httpClient"></param>
//        public FedExRestFreightLtlProvider(FedExProviderConfiguration configuration, HttpClient httpClient)
